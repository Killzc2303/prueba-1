...
<head>
  ...
  <style>
    ...
    .preview{border-radius:10px;overflow:hidden;border:1px solid #e6e9ef;background:#fff;max-width:100%;height:420px;display:grid;place-items:center}
...
<body>
  <main class="card">
    ...
    <!-- BOTONES -->
    <div class="buttons">
      <!-- Cambia los data-image a tus URLs reales -->
      <button class="btn" data-image="https://via.placeholder.com/1200x800?text=Imagen+1" id="btn1">Ver imagen 1</button>
  ...
  <script>
    ...
    // Si quieres que siempre abra en nueva pestaña (sin vista previa),
    // reemplaza el listener anterior por este (comenta el anterior y descomenta):
    /*
    btns.forEach(btn => {
